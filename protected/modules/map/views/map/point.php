...
<!--    <script type="text/javascript" src="../src/MarkerTool/MarkerTool.min.js"></script>-->
    <style type="text/css">
        /* 样式选择面板相关css */
        #divStyle {
            width: 280px;
...
<body>
<div style="width:100%;height:50%;border:1px solid gray" id="container"></div>
...
<script type="text/javascript">
    ...
    function fnOK(){
        ...
        if(curMkr){
            ...
            curMkr.setLabel(lbl);
            let info = new window.BMap.InfoWindow("<p style=’font-size:12px;lineheight:1.8em;’>" + name + "</br>电话：" + tel + "</br> 地址" + addr + "</br></p>"); // 创建信息窗口对象
